...
- (void)viewDidLoad {
    ...
    container1.backgroundColor = [UIColor colorWithWhite:0.7 alpha:1.0];
...
//    .fl_flexGrow(1.0).children(@[label, label1]);
    ...
    [rootView.flex define:^(FlexLayout *flex) {
        flex
        .fl_flexDirection(FLFlexDirectionRow)
        ...
        [flex.addChild(container1) define:^(FlexLayout *flex) { // container1
